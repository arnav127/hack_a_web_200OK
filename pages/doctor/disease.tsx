...
import { usePatientByAadharQuery } from '../../graphql/generated'
            ...
            <div className="container mx-auto">
                ...
                {aadhar && (
                    data?.patient ? (
                        <>
                            <h2>Record found!</h2>
                            <div className="my-4 rounded-lg bg-gray-100/50 p-8">
                                ...
                                <>
                                    ...
                                    {data?.patient?.patientauthorizedhospitalSet.at(-1).hospitalId.id === user?.hospital?.id ?
                                        (
                                            ...
                                            >
                                                <a className="mt-4 py-2 px-4 w-48 font-semibold text-center text-white bg-gray-600 rounded-lg shadow-md transition duration-200 ease-in hover:bg-sky-700 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2 focus:ring-offset-sky-200" >
                                                    View details
                                                </a>
                                            </Link>
                                        )})}</>))}
