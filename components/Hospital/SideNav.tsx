...
const SideNav = () => {
    const { user } = useAuth()
    return (
        <nav className="min-h-screen border-r-2 border-gray-100 px-4 md:w-72">
            <div className="flex h-20 items-center">
                ...
                <h2>
                    <span className="ml-2 text-2xl font-semibold leading-tight">Docco</span><br />
                    <span className="ml-2 font-semibold text-sm">{user?.hospital?.name}</span>
                </h2>
            </div>
            ...
            <div>
                ...
                <NavLink title='Admit New Patient' href='/patient/create' icon={
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
