...
from patientrecord.schemas.medicine_prescription import MedicinePrescriptionQuery, MedicinePrescriptionMutation
from patientrecord.schemas.medicine_record import MedicineRecordQuery, MedicineRecordMutation
